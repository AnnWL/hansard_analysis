...
mp_list = read_json("MP_list.json")
agency_list = read_json("agency_list.json")
ag_theme_topic_dict = read_json("ag_theme_topic_dict.json")
theme_topic_dict = read_json("theme_topic_dict.json")
topic_list = read_json("topic_list.json")
...
df_topic_file = 'social_sector_classification_7Nov.csv'
...
if params_dict['agency']!='None': 
    params_dict['theme'] = input_container.selectbox('Theme', list(ag_theme_topic_dict[params_dict['agency']].keys()))
else: 
    params_dict['theme'] = input_container.selectbox('Theme', sorted(list(theme_topic_dict.keys())), index = sorted(list(theme_topic_dict.keys())).index('None'), help = theme_help)
